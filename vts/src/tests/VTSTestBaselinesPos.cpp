...
bool VTSTestBaselinesPos::initialize(const json& config)
{
    stringstream msg;
...
bool VTSTestBaselinesPos::load()
{
    set_current_state( get_current_state() + 1);
    return true;
}

bool VTSTestBaselinesPos::need_to_redo()
{
...
void VTSTestBaselinesPos::redo_last_step()
{
...
bool VTSTestBaselinesPos::configure()
{
...
bool VTSTestBaselinesPos::process_event(vts::daq::DataFragment* fragment)
{
...
bool VTSTestBaselinesPos::analyze()
{
    TestStep t = m_test_steps.at(get_current_state() - 1);
    int channel = std::stoi(t.channel);
...
bool VTSTestBaselinesPos::analyze_test()
{
...
bool VTSTestBaselinesPos::finalize()
{
...
json VTSTestBaselinesPos::get_results()
{
