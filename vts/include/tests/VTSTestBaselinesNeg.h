#ifndef VTS_TEST_BaselinesNeg_H
#define VTS_TEST_BaselinesNeg_H
...
class VTSTestBaselinesNeg : public VTSTestImp
{
    public :
        explicit VTSTestBaselinesNeg()
        {
